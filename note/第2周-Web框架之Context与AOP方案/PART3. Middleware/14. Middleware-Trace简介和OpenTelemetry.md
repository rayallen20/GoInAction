# 14. Middleware-Trace简介和OpenTelemetry
...
![Tracing的示例-1](../img/14.Middleware-Trace简介和OpenTelemetry/Tracing的示例-1.png)
...
![OpenTelemetry与Jeager结合](../img/14.Middleware-Trace简介和OpenTelemetry/OpenTelemetry与Jeager结合.png)
